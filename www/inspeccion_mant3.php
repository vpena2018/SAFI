      ...
      if (isset($_REQUEST["gg_est"])) { 
        ...
        if (!es_nulo($nuevo_estado)) {
            if ($nuevo_estado==2) {
              ...
              if ($tipodoc==2){
                 $Oservicio=get_dato_sql("servicio","COUNT(*)"," WHERE id_estado not in (20,22) AND id_producto=".intval($_REQUEST['id_producto']));
                 $Ocombustible=get_dato_sql("orden_combustible","COUNT(*)"," WHERE id_estado<3 AND id_producto=".intval($_REQUEST['id_producto']));
                 if (!es_nulo($Oservicio)){
...
<div class="card mb-3">
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">   
          <div class="row"> 
            <div class="col-md">     
                 <?php echo campo("observaciones_adpc","Observaciones ADPC",$oculto,$observaciones_adpc,' ',' rows="2" '.$disable_sec6 .$obadpc_requerido);?>  
            </div>
          </div>
        </div>
      ...
      <div class="row">
          ...
          <div class="botones_accion d-print-none bg-light px-3 py-2 mt-4 border-top ">
            ...
            <?php if (tiene_permiso(163) and es_nulo($id_usuario_auditado)) { ?>
...
var validation = Array.prototype.filter.call(forms, function(form) {
    ...
    if ($("#kilometraje_entrada").val()=='') {
      ...
      var km_min=parseInt($("#kilom etraje_minimo").val());            
    ...
    if (validado==true) {
        ...
        var estado=<?php echo $nuevo_estado; ?>;
            if (cliente>0){
