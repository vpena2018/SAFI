...
<div id="form-1div" class="card">
  <div class="card-body form-1-card-body">	
	   ...
	   <div class="text-center mb-4 form-1-titulo">TRASLADOS VEHICULOS</div>
  
	   <div id="mensaje-cuerpo" class="form-1-body">
  		</div>

	  <div id="form-cuerpo" class="form-1-body">
		  <p class="subtitulo">Busqueda</p>
...
<div class="row align-items-end">
    ...
    <div class="col-md-6">
        <label for="num_inv" class="form-label mb-2">
            CODIGO VEHICULO
        </label>
    ...
    <div class="col-md-3">
        <button type="button"
                ...
                style="min-height: 38px; margin: 9px;"
                onclick="enviar_solicitud(); return false;">
            BUSCAR
        </button>
    </div>
