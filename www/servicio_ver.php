...
<form id="forma_ver" name="forma_ver" >
 <fieldset id="fs_forma">
    ...
    <div class="row"> 
        ...
        <div class="col-sm">        
        <?php 
           echo campo("id_tecnico","Mecanico",'select2',valores_combobox_db('usuario','','nombre',' where activo=1 and (grupo_id=2 or perfil_tecnico=2) ','','Todos'),' ',' onkeypress="buscarfiltro(event,\'btn-filtro\');"');
            ?>
        </div>
