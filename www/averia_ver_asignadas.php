...
if ($accion=="1") {
   // sleep(3);
    ...
    if (isset($_REQUEST['estado'])) { $tmpval=sanear_int($_REQUEST['estado']); if ($tmpval==2){$filtros.=" and averia.id_estado >=20 " ;} else {$filtros.=" and averia.id_estado <20 " ;}   }
...
<div class="table-responsive ">
    <table id="tabla" data-url="averia_ver_asignadas.php?a=1" data-page="0" class="table table-striped table-hover table-sm"  style="width:100%">
