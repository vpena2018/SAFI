 ...
 <fieldset id="fs_forma">
    <div class="row">  
        ...
        <div class="col-sm">
         ...
         <div class="col-sm">
           <?php 
           echo campo("motorista","Motorista",'select',valores_combobox_db('usuario','','nombre',' where activo=1 and (grupo_id=3 or perfil_adicional=3)','','Todos'),' ',' onkeypress="buscarfiltro(event,\'btn-filtro\');"');
            ?>
        </div>
