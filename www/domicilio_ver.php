...
if ($accion=="1") {
   // sleep(3);
    ...
    if (isset($_REQUEST['motorista'])) { $tmpval=sanear_int($_REQUEST['motorista']); if (!es_nulo($tmpval)){$filtros.=" and orden_domicilio.id_motorista=".GetSQLValue($tmpval,'int') ;}  }
 ...
 <fieldset id="fs_forma">
    <div class="row">  
        ...
        <div class="col-sm">
         ...
         <div class="col-sm">
           <?php 
           echo campo("motorista","Motorista",'select2',valores_combobox_db('usuario','','nombre',' where activo=1 and (grupo_id=3 or perfil_adicional=3)','','Todos'),' ',' onkeypress="buscarfiltro(event,\'btn-filtro\');"');
            ?>
        </div>
