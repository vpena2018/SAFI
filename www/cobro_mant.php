...
$result = sql_select("SELECT orden_cobro.id, 
orden_cobro.numero,
orden_cobro.SAP_sinc, 
orden_cobro.fecha
...
?>
  ...
  <div class="row">
     <div class="col-md-6">       
            <?php echo campo("cliente","Cliente",'label',$row["nombre"],' ',' ');  ?>              
     </div>
  ...
  <div class="table-responsive">  
      ...
      <?php
        ...
        $servicios_result = sql_select("SELECT * FROM orden_cobro_detalle where  id_orden=$cid  order by id ");
        $salidatxt='';
